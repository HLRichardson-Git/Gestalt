...
TEST(RSA_Padding, oaep) {
    ...
    OAEPParams parameters = { HashAlgorithm::SHA256, MGF1, ""};
...
TEST(RSA_Padding, oaep2) {
    std::string input = "Hello, Gestalt!";
    OAEPParams parameters = { HashAlgorithm::SHA1, MGF1, "", "aafd12f659cae63489b479e5076ddec2f06cb58f"};
...
TEST(RSA_Remove_Padding, removeOaep) {
    ...
    OAEPParams parameters = { HashAlgorithm::SHA1, MGF1, ""};
