...
const SecureBytes key128    = SecureBytes::fromHex("10a58869d74be5a374cf867cfb473859");
const SecureBytes key192    = SecureBytes::fromHex("e9f065d7c13573587f7875357dfbb16c53489f6a4bd0f7cd");
const SecureBytes key256    = SecureBytes::fromHex("c47b0294dbbbee0fec4757f22ffeee3587ca4730c3d33b691df38bab076bc558");
const SecureBytes plaintext = SecureBytes::fromAscii("Hello, Gestalt!");
const SecureBytes nonce     = SecureBytes::fromHex("01020304050607080910111213141516");
