...
std::string hmacSHA224(const std::string& key, const std::string& input) {
...
std::string hmacSHA384(const std::string& key, const std::string& input) {
    return HMAC(SHA384).keyedHash(key, input, hashSHA384);
}

std::string hmacSHA512(const std::string& key, const std::string& input) {
    return HMAC(SHA512).keyedHash(key, input, hashSHA512);
}

std::string hmacSHA512_224(const std::string& key, const std::string& input) {
    return HMAC(SHA512_224).keyedHash(key, input, hashSHA512_224);
}

std::string hmacSHA512_256(const std::string& key, const std::string& input) {
